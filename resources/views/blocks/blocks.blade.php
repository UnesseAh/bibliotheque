...
<main style="margin-top: 58px; width: 98%" >
    ...
    <div class="container pt-4" >
        ...
        <a href="{{ route('create.block')}}"  class="btn btn-primary mb-3">
            Add Block
        </a>
        <table class="table align-middle mb-0 bg-white table-striped table-bordered text-center ">
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('delete.block', $block) }}" method="POST" >
                        @method('DELETE')
                        @csrf
                        <a href="{{ route('edit.block', $block) }}" class="btn btn-outline-success" data-mdb-ripple-color="dark">
                            Edit
                        </a>
