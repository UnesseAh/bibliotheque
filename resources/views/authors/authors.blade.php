                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('image/' . $author->image) }}" alt="" style="width: 45px; height: 45px" class="rounded-circle"/>
                            <div class="ms-3">
                                <p class="fw-bold mb-1">{{ $author->first_name }} {{ $author->last_name }}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <form action="{{ route('authors.destroy', $author) }}" method="POST" >
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('authors.edit', $author) }}" class="btn btn-outline-success" data-mdb-ripple-color="dark">
                                Edit
                            </a>
