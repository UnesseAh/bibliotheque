...
<div class="container w-25 " style="margin-top: 6rem">
    <div class="card col-lg-12 col-xl-12">
        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="{{ asset('image/dostoevsky.jpg') }}"
        ...
        <div class="card-body p-0 py-4">
            <form method="POST" action="{{ route('authors.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-2">
                    <input name="first_name" value="{{ old('first_name') }}" type="text" id="title" class="form-control" />
                ...
                <!-- Last Name -->
                <div class="form-outline mb-2">
                    <input name="last_name" value="{{ old('last_name') }}" type="text" id="title" class="form-control" />
                ...
                <!-- Country -->
                <div class="form-outline mb-2">
                    <input name="country" value="{{ old('country') }}" type="text" id="country" class="form-control" />
                ...
                <!-- Age -->
                <div class="form-outline mb-2">
                    <input name="age" value="{{ old('age') }}" type="number" id="age" class="form-control" placeholder="age">
